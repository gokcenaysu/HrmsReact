      ...
      <Carousel responsive={responsive} className={classes.card}>
        <Card className={classes.root}>
          <CardActionArea>
            ...
            <CardContent className={classes.content}>
              <Typography className={classes.caption}>APINIZER</Typography>
        ...
        <Card className={classes.root}>
          <CardActionArea>
            ...
            />
            <CardContent className={classes.content}>
              <Typography className={classes.caption}>reddit</Typography>
              <Typography className={classes.desc}>
        ...
        <Card className={classes.root}>
          <CardActionArea>
            ...
            />
            <CardContent className={classes.content}>
              <Typography className={classes.caption}>Kodlamaio</Typography>
              <Typography className={classes.desc}>
                Moderator for Camps
              </Typography>
            </CardContent>
        ...
        <Card className={classes.root}>
          <CardActionArea>
            ...
            />
            <CardContent className={classes.content}>
              <Typography className={classes.caption}>La blanche</Typography>
              <Typography className={classes.desc}>
                Fun, friendly, dancing... will working 10 hours
              </Typography>
            </CardContent>
          </CardActionArea>
          <CardActions>
        ...
        <Card className={classes.root}>
          <CardActionArea>
            ...
            />
            <CardContent className={classes.content}>
              <Typography className={classes.caption}>amazon</Typography>
              <Typography className={classes.desc}>
